...
router.get('/:id', async(req, res) => {
  // finds a single product by its `id` and its associated Category and Tag data
  try {
...
router.post('/', (req, res) => {
  Product.create(req.body)
    .then((product) => {
      // if product tags, then we need to create pairings to bulk create in the ProductTag model
